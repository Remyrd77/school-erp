      ...
      <Sidebar>
        <Navigator>
          <NavBox
            ...
            onClick={(e) => this.activateTab(e)}
          >
            <NavLink to="/student/dashboard">Dashboard</NavLink>
          </NavBox>
          <NavBox
            isChecked={this.state.isChecked}
            onClick={(e) => this.expandProfileMenu(e)}
          >
          ...
          <NavBox
            isChecked
            onClick={() => this.expandAdmissionMenu(this.props)}
          >
          ...
          <NavBox
            isChecked={false}
            onClick={() => this.expandExCurricularMenu(this.props)}
          >
          ...
          <NavBox
            isChecked={false}
            onClick={() => this.expandLeavingCertificateMenu(this.props)}
          >
            ...
            {this.state.onLeavingCertificateToggle && (
              <div>
                ...
                <Nav to="/student/excurricular/edit">
                  <NavBoxSub>
                    <NavLinkSub to="/student/excurricular/edit">
                      Edit
                    </NavLinkSub>
                  </NavBoxSub>
                </Nav>
