...
import {
  FormColumn,
  FormRow,
} from "../../../../components/containers/FormColumn";
...
import {
  ...
  CheckBox,
  CheckBoxLabel,
} from "../../../../components/inputs/Toggler";
        ...
        <form>
          <FormRow>
            <FormColumn>
              <Card>
                <FormRow>
                  <CardHeader>Father's Details</CardHeader>
                </FormRow>
                <FormRow>
                  <FormColumn>
                ...
                <FormRow>
                  <FormColumn>
                    ...
                    <FlatInput
                      placeholder="Father's Moblie No"
                      type="number"
                      name="fatherMobile"
                      id="fatherMobile"
            ...
            <FormColumn>
              <Card>
                <FormRow>
                  <CardHeader>Mother's Details</CardHeader>
                </FormRow>
                <FormRow>
                  <FormColumn>
          ...
          <FormRow style={{ marginTop: "-2em" }}>
            <FormColumn>
              <Card>
                <FormRow>
                  <CardHeader>Guardian's Details</CardHeader>
                </FormRow>
                ...
                <FormRow>
                  ...
                  <FormColumn>
                    ...
                    <FlatInput
                      placeholder="Guardian's Official Address"
                      type="text"
                ...
                <FormRow>
                  <FormColumn>
                    ...
                    <FlatInput
                      placeholder="Guardian's Moblie No"
                      type="number"
                      name="guardianMobile"
                      id="guardianMobile"
            ...
            <FormColumn>
              <Card>
                <FormRow>
                  <CardHeader>Siblings' Details</CardHeader>
                </FormRow>
                <FormRow>
                  <FormColumn>
                    <Label>
                      Does the Student Have Siblings Studying In Our School
                    </Label>
                  </FormColumn>
                    ...
                    <div>
                      <CheckBoxWrapper>
                        <CheckBox
                          ...
                          onChange={(e) =>
                            this.handleToggleStudentHaveSibling(e)
                          }
                        />
                  ...
                  <div>
                    ...
                    <FormRow>
                      <FormColumn>
                        ...
                        <FlatInput
                          placeholder="Sibiling's FullName :"
                          type="text"
          ...
          <FormRow>
            ...
            <FormColumn>
              <Link to="/student/admission/new/step2">
                <PrimaryButton type="button" onClick={this.onSubmit()}>
                  Next
                </PrimaryButton>
              </Link>
            </FormColumn>
